            ...
            <Modal isOpen={isBasicOpen} onClose={() => setIsBasicOpen(false)}>
              <ModalHeader>
                <div>
                  ...
                  <ModalDescription>
                    This is a basic modal with clean, modern styling inspired by
                    Vercel.
                  </ModalDescription>
                </div>
              </ModalHeader>
              <ModalBody>
                <p>
                  ...
                  with excellent typography, subtle shadows, and smooth
                  animations. It includes proper accessibility features like
        ...
        <div className='space-y-3'>
          ...
          <div className='flex flex-wrap gap-3'>
            ...
            >
              <ModalHeader>
                <div>
                  ...
                  <ModalDescription>
                    Enhanced shadows and rounded corners for a contemporary
                    look.
                  </ModalDescription>
                </div>
              </ModalHeader>
              <ModalBody>
                <div className='space-y-4'>
                  <p>
                    ...
                    larger border radius for a sleek, contemporary appearance.
                  </p>
              ...
              <ModalFooter>
                <Button onClick={() => setIsModernOpen(false)}>Awesome!</Button>
              </ModalFooter>
            </Modal>
            ...
            >
              ...
              <ModalBody>
                <p>
                  The minimal variant removes the border for an even cleaner
                  appearance, perfect for content-focused dialogs.
                </p>
              </ModalBody>
              <ModalFooter>
                <Button onClick={() => setIsMinimalOpen(false)}>Close</Button>
              </ModalFooter>
            </Modal>
            ...
            >
              ...
              <ModalBody>
                <p>
                  The elevated variant uses a sophisticated multi-layer shadow
                  system to create a sense of depth and importance.
                </p>
              </ModalBody>
              <ModalFooter>
                <Button onClick={() => setIsElevatedOpen(false)}>Close</Button>
              </ModalFooter>
            </Modal>
          </div>
        </div>
        ...
        <div className='space-y-3'>
          ...
          <div className='flex flex-wrap gap-3'>
            ...
            >
              ...
              <ModalBody>
                <p>
                  This will permanently delete the selected item and remove all
                ...
                <div className='space-y-4'>
                  {Array.from({ length: 20 }, (_, i) => (
                    <p key={i} className='text-sm'>
                      {i === 0 &&
                        'This is a demonstration of scrollable content within a modal. '}
