          ...
          <div className='flex h-full'>
            ...
            <div className='flex-1 p-6'>
              ...
              <div className='space-y-3 text-neutral-600 dark:text-neutral-400'>
                <p>This sidebar features an integrated footer that combines:</p>
                ...
                <div className='mt-4 p-4 bg-neutral-50 dark:bg-neutral-800/30 rounded-lg'>
                  ...
                  <p className='text-sm'>
                    Click the collapse button to see how the sidebar adapts, or
                    click on the user profile area for custom actions.
                  </p>
                </div>
              </div>
            </div>
