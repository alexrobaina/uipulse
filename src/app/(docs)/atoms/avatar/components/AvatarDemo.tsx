    ...
    <Preview>
      <div className='space-y-8 w-full'>
        ...
        <div className='space-y-3'>
          ...
          <div className='space-y-3'>
            <div className='flex items-center space-x-3'>
              <Avatar variant='circle' fallback='Circle Avatar' size='lg' />
              <span className='text-sm text-neutral-500 dark:text-neutral-400'>
                Circle (Default)
              </span>
            </div>
            <div className='flex items-center space-x-3'>
              <Avatar variant='rounded' fallback='Rounded Avatar' size='lg' />
              <span className='text-sm text-neutral-500 dark:text-neutral-400'>
                Rounded
              </span>
            </div>
            <div className='flex items-center space-x-3'>
              <Avatar variant='square' fallback='Square Avatar' size='lg' />
              <span className='text-sm text-neutral-500 dark:text-neutral-400'>
                Square
              </span>
            </div>
        ...
        <div className='space-y-3'>
          ...
          <div className='space-y-3'>
            ...
            <div className='flex items-center space-x-3'>
              <Avatar fallback='Away User' showStatus status='away' size='lg' />
              <span className='text-sm text-neutral-500 dark:text-neutral-400'>
                Away
              </span>
            </div>
            <div className='flex items-center space-x-3'>
              <Avatar fallback='Busy User' showStatus status='busy' size='lg' />
              <span className='text-sm text-neutral-500 dark:text-neutral-400'>
                Busy
              </span>
            </div>
        ...
        <div className='space-y-3'>
          ...
          <div className='space-y-3'>
            ...
            <div className='flex items-center space-x-3 p-3 bg-neutral-50 dark:bg-neutral-800/50 rounded-lg'>
              <Avatar fallback='Jane Smith' showStatus status='away' />
              <div>
                <p className='text-sm font-medium text-neutral-700 dark:text-neutral-300'>
                  Jane Smith
                </p>
        ...
        <div className='space-y-3'>
          ...
          <div className='flex items-center space-x-4'>
            ...
            />
            <Avatar fallback='No Image' alt='Just initials' />
            <Avatar fallback='' alt='Empty fallback shows ?' />
          </div>
        </div>
      </div>
    </Preview>
