export const toggleGroupCode = `"use client";
...
const ToggleGroup: React.FC<ToggleGroupProps> = ({
  ...
  const variantClasses = {
    ...
    outline: {
      ...
      active: "border-blue-500 bg-blue-50 text-blue-700 dark:border-blue-400 dark:bg-blue-900/20 dark:text-blue-300",
      inactive: "text-neutral-700 hover:text-neutral-900 hover:border-neutral-400 hover:bg-neutral-50 dark:text-neutral-300 dark:hover:text-neutral-100 dark:hover:border-neutral-500 dark:hover:bg-neutral-800",
    },
    ghost: {
      container: "flex gap-1",
      item: "rounded-md font-medium transition-all duration-150",
