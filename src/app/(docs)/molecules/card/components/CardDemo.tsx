        ...
        <div className='space-y-3'>
          ...
          <Card className='max-w-md'>
            <CardHeader>
              ...
              <CardDescription>
                A modern web application built with React and TypeScript for
                scalable development.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <p>
                This project demonstrates advanced patterns in modern web
                development, including server-side rendering, real-time updates,
        ...
        <div className='space-y-3'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
            <Card variant='default'>
              ...
              <CardContent>
                Perfect for general content and standard layouts with balanced
                visual weight.
              </CardContent>
            </Card>
            ...
            <Card variant='elevated' interactive>
              ...
              <CardContent>
                <p className='text-sm mb-4'>
                  ...
                  mentoring junior developers. Expert in React ecosystem,
            ...
            <Card variant='elevated' interactive>
              ...
              <CardContent>
                <p className='text-sm mb-4'>
                  ...
                  delightful user experiences for complex applications and
                  design systems.
                </p>
                <div className='flex flex-wrap gap-2'>
        ...
        <div className='space-y-3'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
            <Card variant='modern'>
              ...
              <CardContent>
                <p>
                  Ideal for dashboard widgets and condensed information
                  displays.
                </p>
              </CardContent>
            </Card>
            ...
            <Card size='lg' variant='modern'>
              ...
              <CardContent>
                <p>
                  Perfect for highlighting key information, creating focal
                  points in your layout, or showcasing important features with
