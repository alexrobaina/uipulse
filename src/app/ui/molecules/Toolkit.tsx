...
const Toolkit: React.FC<ToolkitProps> = ({
  ...
  const currentActiveItems =
    activeItems.length > 0 ? activeItems : internalActiveItems;
  ...
  const variantClasses = {
    ...
    outline: {
      container:
        'border border-neutral-200 dark:border-neutral-700 rounded-lg p-1',
      item: 'rounded-md border border-transparent transition-all duration-150',
      active:
        'border-blue-200 bg-blue-50 text-blue-700 dark:border-blue-800 dark:bg-blue-900/20 dark:text-blue-300',
      inactive:
        'text-neutral-600 hover:text-neutral-900 hover:border-neutral-300 hover:bg-neutral-50 dark:text-neutral-400 dark:hover:text-neutral-100 dark:hover:border-neutral-600 dark:hover:bg-neutral-800',
      disabled: 'opacity-50 cursor-not-allowed',
    },
    ghost: {
      container: '',
    ...
    filled: {
      ...
      inactive:
        'text-neutral-400 hover:text-white hover:bg-neutral-700 dark:text-neutral-600 dark:hover:text-neutral-900 dark:hover:bg-neutral-200',
      disabled: 'opacity-50 cursor-not-allowed',
    },
  };
