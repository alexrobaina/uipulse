export const buttonGroupImplementation = `import React, { forwardRef, HTMLAttributes, ReactElement, ReactNode } from "react";
...
const buttonGroupItemVariants = cva(
  ...
  ],
  {
    variants: {
      variant: {
        ...
        secondary: [
          ...
          "hover:bg-gray-200",
          "focus:z-10 focus:ring-gray-500",
          "active:bg-gray-300",
    ...
    compoundVariants: [
      ...
      // Additional compound variants for other combinations...
    ],
    defaultVariants: {
      variant: "default",
      size: "md",
          ...
          if (React.isValidElement(child)) {
            ...
            return React.cloneElement(child as ReactElement<any>, {
              ...
              className: cn(
                ...
                (child as ReactElement<any>).props.active && 
...
const ButtonGroupItem = forwardRef<HTMLButtonElement, ButtonGroupItemProps>(
  ({ children, className, disabled = false, active = false, ...props }, ref) => {
    return (
      <button
        ref={ref}
        disabled={disabled}
