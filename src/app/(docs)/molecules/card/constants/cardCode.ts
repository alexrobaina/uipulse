    ...
    compoundVariants: [
      {
        interactive: true,
        variant: "elevated",
        className: "hover:shadow-2xl hover:shadow-neutral-200/30 dark:hover:shadow-neutral-900/60",
      },
      {
        interactive: true,
        variant: "modern",
        className: "hover:shadow-[0_12px_40px_0px_rgba(0,0,0,0.08)] dark:hover:shadow-[0_12px_40px_0px_rgba(0,0,0,0.3)]",
      },
    ],
  }
);
