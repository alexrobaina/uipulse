...
export default function EnhancedSidebarDemo() {
  ...
  const demoUser = {
    ...
    avatar:
      'https://images.unsplash.com/photo-1494790108755-2616b9dae55d?w=150',
    status: userStatus,
  };
    ...
    <div className='max-w-7xl mx-auto p-6 space-y-6'>
      <div className='mb-8'>
        ...
        <p className='text-neutral-600 dark:text-neutral-400'>
          Experience the new integrated sidebar with user profile and collapse
          functionality.
        </p>
      </div>
      ...
      <Card className='mb-6'>
        ...
        <CardContent>
          <div className='flex flex-wrap items-center gap-4'>
            ...
            <Badge variant='outline'>User clicks: {userClickCount}</Badge>
          </div>
        </CardContent>
      </Card>
            ...
            <div className='flex-1 p-6 bg-neutral-50/50 dark:bg-neutral-900/20'>
              <div className='h-full flex flex-col'>
                <div className='mb-6'>
                  ...
                  <p className='text-neutral-600 dark:text-neutral-400'>
                    This enhanced sidebar combines user management with
                    navigation controls.
                  </p>
                </div>
                    ...
                    <CardContent className='space-y-4'>
                      <div className='space-y-2'>
                        ...
                        <ul className='text-xs text-neutral-600 dark:text-neutral-400 space-y-1'>
                          ...
                          <li>
                            • Click the user profile to increment the counter
                          </li>
